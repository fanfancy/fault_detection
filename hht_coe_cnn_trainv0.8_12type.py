...
if net_mode == 1:
    from cnn_model_new_12type import *
...
for linenum in linenum_all:
    ...
    #################### 12 type #################################################
    type_label = np.zeros((kinds,12),dtype=int)
    for i in range (kinds):
        if ("rand300_1"in name[i]): type_label[i][ 0] = 1
        elif ( "_AG_" in name[i] ): type_label[i][ 1] = 1
        elif ( "_BG_" in name[i] ): type_label[i][ 2] = 1
        elif ( "_CG_" in name[i] ): type_label[i][ 3] = 1
        elif ( "_AC_" in name[i] ): type_label[i][ 4] = 1
        elif ( "_BC_" in name[i] ): type_label[i][ 5] = 1
        elif ( "_AB_" in name[i] ): type_label[i][ 6] = 1
        elif ("_ACG_" in name[i] ): type_label[i][ 7] = 1
        elif ("_BCG_" in name[i] ): type_label[i][ 8] = 1
        elif ("_ABG_" in name[i] ): type_label[i][ 9] = 1
        elif ("_ABC_"  in name[i] ): type_label[i][10] = 1
        elif ("_ABCG_"in name[i] ): type_label[i][11] = 1
        print (name[i],type_label[i])
    ...
    type_label_train = type_label[:int(kinds*0.75)]
    type_label_test = type_label[int(kinds*0.75):]
    ...
    if faulttype == 1:
        ...
        label_train_current_net = type_label_train
        label_test_current_net = type_label_test
        ...
        if record:
            with open("0308_12type_netmode1.txt",'a+') as f:
                f.write("@ train %s.\n" % (linenum))

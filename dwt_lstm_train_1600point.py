...
from readdata_dwt import load_data_1600
from dwt_model import *
from dwtprocess import *
  
####read file ############
linenum_all = ['269', '313', '316', '75', '72', '69', '66']
# linenum_all = ['49']
# linenum_all = ['316']
# linenum_all = ['100002']
...
for linenum in linenum_all:
    ...
    fault_kinds = fault_type * repeat_times
    kinds = fault_kinds + normal
    
    X_train, y_train = load_data_1600(filename,length,kinds)
    ...
    epochs = 800
    layers = [3, length, 128, 32, 6, dwt_length]

...
diff_conditions = 16                       #load change nums
    ...
    for snr in SNR:
        ...
        if record:
            with open("log_htt2.txt", 'a+') as f:
                ...
                f.write("@ Best Training Accuracy: %.2f %% achieved at EP #%d.\n" % (acc[m_acc] * 100, m_acc + 1))
                f.write("@ Best Testing Accuracy: %.2f %% achieved at EP #%d.\n" % (val_acc[m_val_acc] * 100, m_val_acc + 1))
                f.write("@ Last Training Accuracy: %.2f %% ." % (acc[-1] * 100))
                f.write("@ Last Testing Accuracy: %.2f %% ." % (val_acc[-1] * 100))
        ...
        if record:
            with open("log_htt2.txt", 'a+') as f:
                ...
                f.write("@ Last Training Accuracy: %.2f %% ." % (mae[-1] * 100))
                f.write("@ Last Testing Accuracy: %.2f %% ." % (val_mae[-1] * 100))
        K.clear_session()

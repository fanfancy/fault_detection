...
net_mode = 5  using current data directly with DWT coe
net_mode = 6  cnn kernel test
'''
net_mode = 5
if net_mode == 1:
...
for linenum in linenum_all:
    ...
    if net_mode == 1 or net_mode == 4 or net_mode == 5:
        ### current data for CNN
    ...
    if net_mode == 2 or net_mode == 3 or net_mode == 4 or net_mode == 6:
	### using hht 
    ...
    if net_mode == 5:
        ...
        layers = [length,3,1,dwt_length]
        DWT_coefficients_type = input_dwt[index,:]
    ...
    if net_mode==1:
        ...
        input_data = {'main_input':data3_type,'dwt_co_input':DWT_coefficients_type}
    elif net_mode==6:
        input_data = {'main_input':data2_type,'hht_co_input':HHT_coefficients_type}
...
############### Phase test ########################2
    ...
    if net_mode==1:
        ...
        input_data = {'main_input':data3_phase,'dwt_co_input':DWT_coefficients_phase}    
    elif net_mode==6:
        input_data = {'main_input':data2_phase,'hht_co_input':HHT_coefficients_phase}
